...
";
        ...
        private static void WriteDeployments(IList<BicepFile> bicepFiles, CodeWriter sourceBuilder)
        {
            ...
            sourceBuilder
                ...
                .OpenBlock()
                    .AppendLine("[Nuke.Common.Tooling.PathExecutable(name: \"az\")]")
                    .AppendLine("private static Nuke.Common.Tooling.Tool Az => Nuke.Common.ValueInjection.ValueInjectionUtility.TryGetValue(() => Az);")
                    .AppendLine()
